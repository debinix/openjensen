        ...
        ?>
          ...
          <tbody>        
            <tr>   
              ...
              <td><?php if($user_row[$i]['grade_grade'] != "-") { ?><a href="course.add.php?user_id=<?php echo $user_row[$i]['user_id']; ?>&course_id=<?php echo $user_row[$i]['course_id']; ?>"><span class="label label-primary">Sätt betyg</span></a><?php } else { ?><a href="course.edit.php?id=<?php echo $user_row[$i]['grade_id']; ?>"><span class="label label-primary">Ändra betyget</span></a><?php } ?></td>
            </tr>
          </tbody>           
